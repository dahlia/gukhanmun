...
This policy is inspired by [Fedify's AI policy][1].

The Gukhanmun project has the following rules for AI usage:
...
These rules apply only to outside contributions to Gukhanmun.  Maintainers are
...
Please remember that Gukhanmun is maintained by humans.
...
Gukhanmun is written with plenty of AI assistance, and the maintainer embraces
AI tools as a productive part of the workflow.  As a project, we welcome AI as
a tool!

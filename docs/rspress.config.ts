// Gukhanmun: Rspress configuration for the Gukhanmun documentation site.
...
export default defineConfig({
  ...
  plugins: [
    ...
    pluginTypeDoc({
      entryPoints: [
        path.join(path.dirname(__dirname), "packages", "types", "index.ts"),
        path.join(path.dirname(__dirname), "packages", "napi", "index.ts"),
